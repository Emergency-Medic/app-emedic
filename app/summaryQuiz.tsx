  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.slide}>
            ...
            <Text style={styles.title}>Emedic (Emergency Medic)</Text>
            <Text style={styles.description}>
                "Emedic adalah aplikasi yang membantu Anda dalam pertolongan pertama dan menjaga kesehatan Anda."
            </Text>
            </View>
        ...
        <View style={styles.slide}>
            ...
            <View style={styles.contentBottomContainer}>
            <Text style={styles.title}>Belajar Seputar Pertolongan Pertama</Text>
            <Text style={styles.description}>
